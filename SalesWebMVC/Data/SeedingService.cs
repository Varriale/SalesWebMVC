...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Alex Almeida", "alex@gmail.com", 1500, new DateTime(1991, 1, 1), d1);
            Seller s2 = new Seller(2, "Bruno Boeira", "bruno@gmail.com", 1300, new DateTime(1992, 2, 2), d2);
            Seller s3 = new Seller(3, "Carlos Carvalho", "carlos@gmail.com", 1800, new DateTime(1993, 3, 3), d3);
            Seller s4 = new Seller(4, "Daniel Dantas", "daniel@gmail.com", 2300, new DateTime(1994, 4, 4), d4);
            Seller s5 = new Seller(5, "Eduardo Esteves", "eduardo@gmail.com", 3500, new DateTime(1995, 5, 5), d1);
            Seller s6 = new Seller(6, "Flávio Fernandes", "flavio@gmail.com", 1200, new DateTime(1996, 6, 6), d2);
